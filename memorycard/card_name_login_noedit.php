				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<form class="navbar-form navbar-left" method ="GET" role="search" action="search.php">
						<div class="form-group">
							...
							<button type="submit" id="submit_search" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
								...
								<div class="col-md-4">
									<div class="flip-container" onclick="this.classList.toggle('active');">
										...
										<div class="back">
												...
												?>
														<div class="boxx-border clearfix">
															<p class="back_card"><?php echo $array_cards['backCard'] ?></p>
														</div>
												<?php
													}
												?>
